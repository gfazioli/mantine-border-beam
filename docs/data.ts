...
export const PACKAGE_DATA: PackageData = {
  packageName: '@gfazioli/mantine-border-beam',
  packageDescription: 'A Mantine component that adds a reflection effect to its children.',
  mdxFileUrl: 'https://github.com/gfazioli/mantine-border-beam/blob/master/docs/pages/index.mdx',
  repositoryUrl: 'https://github.com/gfazioli/mantine-border-beam',
  licenseUrl: 'https://github.com/gfazioli/mantine-border-beam/blob/master/LICENSE',
  author: {
